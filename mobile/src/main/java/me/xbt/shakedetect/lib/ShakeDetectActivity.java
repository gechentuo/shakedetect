package me.xbt.shakedetect.lib;
...
public class ShakeDetectActivity implements SensorEventListener {
	...
	private static final float POSITIVE_COUNTER_THRESHHOLD = (float) 1.0;
	private static final float NEGATIVE_COUNTER_THRESHHOLD = (float) -1.0;
